...
export default function HotelTable() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen flex flex-col justify-center items-center px-6 py-16 bg-gradient-to-br from-neutral-100 to-neutral-200 overflow-hidden"
    >
      ...
      >
        {hotels.map((hotel, idx) => (
          ...
          >
            ...
            <h3 className="font-serif text-2xl text-[#2C2C2C] mb-4 relative after:content-[''] after:block after:w-14 after:h-[2px] after:bg-[#D4AF37] after:mt-2">
